...
export class AdminComponent implements OnInit {
    ...
    reported_users = [{naam: "Harald", reason: "harassment"}, {naam: "Justin", reason: "harassment"},{naam: "Anne Pier", reason: "bullying"},{naam: "Merel", reason: "harassment"},{naam: "Robbin", reason: "harassment"},]
  constructor() { }
